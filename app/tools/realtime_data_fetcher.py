...
class RealTimeData(BaseModel):
    ...
    data_type : List[str] = Field(...,description = "List Of Metrics (e.g. ['price','market_cap','volume'])")
    period : str = Field(...,description = "Period to fetch data for must be one of: 1d, 5d, 1mo, 3mo, 6mo, 1y, 2y, 5y, 10y, ytd, max")
...
if __name__ == '__main__':
    result = fetch_real_time_data.invoke({'query' : "What is the current stock price of Apple and tell its high and low",'role' : 'analyst'})
    print(result)
